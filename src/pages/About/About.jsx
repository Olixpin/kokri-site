          ...
          <main className="about-main">
            ...
            <section className="section-about-grid">
              ...
              <div className="section-expertise-grid-wrap">
                ...
                <article className="section-expertise-grid-box">
                  <h4>Strategists</h4>
                  <h5>
                    Who build on this knowledge and define how brands can
                    connect with our changing needs and desires.
                  </h5>
            ...
            <div className="award-content-wrap">
              ...
              <div className="section-award-subheader">
                <p>
                  Our unique approach to designing for life has resulted in a
                  host of global creative awards as has seen us win prestigious
                  design effectiveness awards for the past 20 consecutive years.
                </p>
              </div>
                ...
                <div className="section-dont-grid-wrap">
                  <article className="section-dont-grid-box">
                    ...
                    <p>
                      ...
                      environment. We believe in responsibly designing to make
                      our planet and peoples' lives better, not compromising
                      them.
                    </p>
                  </article>
                  <article className="section-dont-grid-box">
                    ...
                    <p>
                      ...
                      creative pitches – or free exclusivity. It's simply not
                      good business for anyone. We believe that the most
                      professional, valuable and effective work is built on the
                      foundation of close collaboration, reciprocal partnership
                  ...
                  <article className="section-dont-grid-box">
                    ...
                    <p>
                      ...
                      culture where everyone is treated with respect and
                      dignity. Each of us thrive when everyone feels valued for
                      who they are, regardless of gender, race, religion, social
                      className, disability, sexual orientation or background.
                      We leave no room for discrimination of any kind because we
                      believe we have a unique opportunity and obligation to
                      design more equitable ways of living and working.
                    </p>
                  </article>
                </div>
              </section>
